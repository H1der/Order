...
//        System.out.println(productInfoPage.getTotalElements());
    ...
    public void save() {
        ...
        productInfo.setProductName("绵绵冰");
        productInfo.setProductPrice(new BigDecimal(3.2));
        productInfo.setProductStock(100);
        productInfo.setProductDescription("芒果绵绵冰");
    ...
    @Test
    public void onSale() {
        ProductInfo result = productService.onSale("123459");
        Assert.assertEquals(ProductStatusEnum.UP, result.getProductStatusEnum());
    }

    @Test
    public void offSale() {
        ProductInfo result = productService.offSale("123459");
